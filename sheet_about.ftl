...
<@layout title="${sheet.title!'关于'} | ${options.blog_title!}">
  <script type="text/javascript">
    document.getElementById("about-context").style.backgroundImage = "url('https://cdn.jsdelivr.net/gh/keepli/image@1.0/img/1.0/img-15.jpg')";
  </script>
  <main class="mx-auto" id="container">
    ...
    <#--      </#if>-->
    <#--      <p>THEME MADE BY <a href="https://github.com/keepli/bao">Nutssss</a></p>-->
    <#--    </div>-->
  </main>
</@layout>
